question_rating_vote = (e) ->
  $('.question-vote-action').bind 'ajax:success', (e, data, status, xhr) ->
    ...
    $('.question_rating_vote').html("<h4><span class='glyphicon glyphicon-heart'>&nbsp;" + vote.rating + "</span></h4>")
    return undefined
...
answer_rating_vote = (e) ->
  $('.answer-vote-action').bind 'ajax:success', (e, data, status, xhr) ->
    ...
    $("#answer-#{vote.id}-rating").html("<h4><span class='glyphicon glyphicon-heart'>&nbsp;" + vote.rating + "</span></h4>")
    return undefined
